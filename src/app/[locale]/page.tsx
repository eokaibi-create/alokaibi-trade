    ...
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-20 md:py-32">
          <div className="max-w-3xl">
            ...
            <a
              ...
              className="inline-block px-8 py-3 bg-white text-blue-700 font-semibold rounded-lg hover:bg-blue-50 transition shadow-lg"
            >
              {t.home.hero.cta}
            </a>
          </div>
            ...
            {categories.map((cat) => {
              ...
              return (
                <a
                  ...
                  className="group bg-gray-50 hover:bg-blue-50 rounded-xl p-6 text-center transition border border-gray-100 hover:border-blue-200"
                >
                  <div className="text-4xl mb-3">{categoryEmojis[cat.slug] || cat.icon || "📦"}</div>
        ...
        <section className="py-16 md:py-20 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-500 max-w-2xl mx-auto">A selection of our premium products</p>
            </div>
      ...
      <section className="py-16 bg-gradient-to-br from-blue-600 to-indigo-800 text-white text-center">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <p className="text-blue-100 mb-8 max-w-xl mx-auto">{t.home.cta_section.desc}</p>
          <a
            href={`/${locale}/inquiry`}
            className="inline-block px-8 py-3 bg-white text-blue-700 font-semibold rounded-lg hover:bg-blue-50 transition shadow-lg"
          >
